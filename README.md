...
The [`bootstrap`](https://github.com/tadelv/mac-bootstrap/blob/master/bootstrap) script is very specific to the Mac platform. It has been successfully tested on the following versions of macOS:
...
* Step 1: Run my adaptation of thoughtbot's [Laptop script](https://github.com/thoughtbot/laptop). This is a provisioning script which installs lots of goodies like Homebrew, rbenv, postgres, etc. My version is now stored locally in this repo under [`install/laptop`](https://github.com/tadelv/mac-bootstrap/blob/master/install/laptop). Step 1 also sets up a [Brewfile](https://github.com/Homebrew/homebrew-bundle#usage), installing a variety of Homebrew packages, casks, and now [Mac App Store apps](https://github.com/argon/mas)!
...
* Step 5: Install various [executable scripts](https://github.com/tadelv/mac-bootstrap/tree/master/bin) (for Tmux and Git) to `$HOME/bin`.
...
* Step 10: Set a variety of [macOS defaults](https://github.com/tadelv/mac-bootstrap/blob/master/install/macos-defaults). (adapted from [https://mths.be/macos](https://mths.be/macos)) Step 10 also customizes the [macOS dock](https://github.com/kcrawford/dockutil).
...
2) Review the 10 steps in [`bootstrap`](https://github.com/tadelv/mac-bootstrap/blob/master/bootstrap) and make your own customizations. Here's an overview of what's going on:

* Step 1 (required): Take a look at [Laptop](https://github.com/tadelv/mac-bootstrap/blob/master/install/laptop) and see what you might want to tweak. One of the biggest things is the Brewfile, which you can find in this repo under `install/Brewfile`. Here you can customize all the packages, casks, and MAS apps that will be installed. Laptop also sets up some basics that are required by the bootstrap script later on.
* Step 2 (recommended): Use `oh-my-zsh`?
* Step 4 (required): The dotfiles. Update the `$DOTFILES_*` variables (see [`bootstrap`](https://github.com/tadelv/mac-bootstrap/blob/master/bootstrap) under "Variable declarations") to reference your dotfiles. As a starting point, you can [fork mine](http://jsua.co/dotfiles) and then point to your fork.
...
Copyright (c) 2016 Joshua Steele. [MIT License](https://github.com/tadelv/mac-bootstrap/blob/master/LICENSE)
